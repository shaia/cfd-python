...
class TestRunSimulation:
    ...
    def test_run_simulation_with_domain_bounds(self):
        ...
        result = cfd_python.run_simulation(5, 5, steps=3, xmin=-1.0, xmax=1.0, ymin=-1.0, ymax=1.0)
        assert isinstance(result, list)
...
class TestRunSimulationWithParams:
    ...
    def test_returns_dict(self):
        ...
        result = cfd_python.run_simulation_with_params(5, 5, 0.0, 1.0, 0.0, 1.0, steps=3)
    ...
    def test_result_has_dimensions(self):
        ...
        result = cfd_python.run_simulation_with_params(5, 7, 0.0, 1.0, 0.0, 1.0, steps=3)
        assert result["nx"] == 5
        assert result["ny"] == 7
    ...
    def test_custom_dt_and_cfl(self):
        ...
        result = cfd_python.run_simulation_with_params(
            5, 5, 0.0, 1.0, 0.0, 1.0, steps=3, dt=0.0005, cfl=0.1
        )
        assert isinstance(result, dict)
    ...
    def test_with_output_file(self, tmp_path):
        ...
        result = cfd_python.run_simulation_with_params(
            5, 5, 0.0, 1.0, 0.0, 1.0, steps=3, output_file=str(output_file)
        )
